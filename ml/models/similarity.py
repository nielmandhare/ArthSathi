...
class StructuredSimilarityRanker:
    ...
    def rank(self, profile, schemes=None, top_k=None):
        ...
        # Target evidence breaks ties among similarly relevant schemes; it
        # cannot rescue an unrelated scheme with sparse evidence.
        ranked = features.sort_values(["relevance_score", "_target_priority", "ranking_score", "evidence_coverage", "match_score", "scheme_id"], ascending=[False, False, False, False, False, True], kind="mergesort")
